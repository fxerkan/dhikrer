...
SPECS = [
    ...
    ("customize", "08-ayarlar-lavanta-v1.png", (40, 22, 52), (62, 26, 66), (214, 140, 214), (238, 190, 236),
     "Tasarımı sana göre", "10+ tema, 30+ şekil ve özelleştirilebilir sayaç",
     "10+ themes, 30+ shapes & a customizable counter"),
    ("easy", "03-birlesik-gul-v1.png", (46, 30, 20), (62, 40, 22), (240, 176, 92), (250, 214, 160),
     "Sade, kullanımı kolay", "Dikkat dağıtan öğeler olmaksızın — tek dokunuşla say",
     "Count with one tap — no distractions."),
